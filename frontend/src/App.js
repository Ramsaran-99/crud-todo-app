...
function App() {
  ...
  return (
    ...
    <form className='form' onSubmit={createTodo}>
      <input type='text' className='form_input' placeholder='Add new Todo' required value={task} onChange={(e)=> setTask(e.target.value)} />
      <button type='submit' className='todo-add_button'>
        Create Todo
      </button>
    </form>
